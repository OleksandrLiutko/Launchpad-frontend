      ...
      <AppContainer>
        <div className="py-28">
          <div className="text-center mx-auto max-w-3xl">
            <SectionHeader>WHAT MAKES GASPAD UNIQUE ?</SectionHeader>
          </div>
          <div
            data-aos="fade-up"
            data-aos-delay="200"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-10">
            <Card data-aos="flip-left" data-aos-duration="2000" style={{background: 'radial-gradient(171.79% 171.79% at 49.92% -51.64%, #a11f1f69 0%, rgba(121, 26, 24, 0) 100%)'}}>
              <img
            ...
            <Card data-aos="flip-left" data-aos-duration="2500" style={{background: 'radial-gradient(171.79% 171.79% at 49.92% -51.64%, #a11f1f69 0%, rgba(121, 26, 24, 0) 100%)'}}>
              <img
            ...
            <Card data-aos="flip-left" data-aos-duration="3000" style={{background: 'radial-gradient(171.79% 171.79% at 49.92% -51.64%, #a11f1f69 0%, rgba(121, 26, 24, 0) 100%)'}}>
              <img
                src={flexibleIcon}
                alt="Flexible"
                width={80}
