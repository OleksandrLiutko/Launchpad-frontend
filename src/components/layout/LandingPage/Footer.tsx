...
import dotLogo from '../../../assets/images/gas_logo.png';
    ...
    >
      <AppContainer>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pb-16">
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-center space-x-4">
              <img src={dotLogo} alt="Gaspad Logo" />
            ...
            <div className="border-t-4 border-b-4 border-custom-dark-primaryBlue py-6 text-center">
              <a className="text-lg" href="mailto:info@gaspad.io">
                info@gaspad.io
              </a>
            </div>
        ...
        <div className="text-center pt-5 text-gray-400">
          <p>
            &#169; {new Date().getFullYear()} GasPad. All rights reserved
          </p>
        </div>
      </AppContainer>
    </div>
