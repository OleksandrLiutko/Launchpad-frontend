          ...
          <div className="space-y-24 md:space-y-48">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-3 flex flex-col justify-center">
                <FeaturesHeader>Gas-Launch</FeaturesHeader>
                <FeaturesSubHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-5 md:order-first flex flex-col justify-center">
                <FeaturesHeader>Gas-Mint</FeaturesHeader>
                <FeaturesSubHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-5 flex flex-col justify-center">
                <FeaturesHeader>Gas-Lock</FeaturesHeader>
                <FeaturesSubHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-5 md:order-first flex flex-col justify-center">
                <FeaturesHeader>Gas-Drop</FeaturesHeader>
                <FeaturesSubHeader>
